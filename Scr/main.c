...
void InitCPU(void)
{
    ...
    TCCR1B = (0<<ICNC1|0<<ICES1|0<<WGM13|0<<WGM12|0<<CS12|1<<CS11|0<<CS10); //������ - 0 "����������"
    REG_TIMSK_1  = (1 << TOIE1);//
    REG_UCSRA  = 0;
    REG_UCSRB  = 0;
#ifndef TEST_MODE    
...
#endif
{
	...
	if (D_pc.Counter_Byte_To_PC < UARTBUF)  
  {
	...
	TCNT2 = CNT_SPEED; //237    //�������� ������ 0 1,25 ��
	REG_TCCR2 = 0x07;//0B00000101; //��������� ������ 0 c ������������� /1024	
}
...
{
    REG_TCCR2 = 0;     
    REG_UCSRB &= ~(1<<B_RXEN|1<<B_RXCIE); //	��������� �������� UART ModBus																										//	��������� ���������� ��������� UARt
